...
def get_args(args):
    ...
    parser.add_argument('--model', default='Trans18', type=str)
    ...
    parser.add_argument('--image_size', default=10, type=int)
    parser.add_argument('--nb_drivers', default=2, type=int)
    ...
    parser.add_argument('--typ', default=33, type=int)
